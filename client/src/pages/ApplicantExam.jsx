      ...
      <main className="canvaMain">
        <div className="canvaTopbar">
          <div className="canvaTopbarLeft">
            <div className="canvaPageTitle">Exam</div>
            <div className="canvaPageSubtitle">Take your assessment when you’re ready.</div>
          </div>
              ...
              <>
                <div className="canvaHero">
                  ...
                  <div className="canvaHeroDesc">
                    Next step: we’ll fetch your assigned exam, render questions, and submit answers for scoring.
                  </div>
                </div>
                ...
                <div className="canvaEmpty">
                  ...
                  <div className="canvaEmptyDesc">
                    When an exam is assigned, it will appear here. After completion, an admin may issue a certificate.
                  </div>

                  <div className="canvaEmptyActions">
                    <button className="canvaPrimary" onClick={() => navigate("/modules")}>
                      View Modules
                    </button>
